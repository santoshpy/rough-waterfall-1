"""
Django settings for rough_waterfall_1 project.
...
ROOT_URLCONF = 'rough_waterfall_1.urls'
...
WSGI_APPLICATION = 'rough_waterfall_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rough_waterfall_1 API",
    "DESCRIPTION": "API documentation for rough_waterfall_1 App",
    "VERSION": "v1",
}
